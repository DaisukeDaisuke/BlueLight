...
class LevelSoundEventPacket extends DataPacket{
	...
	const SOUND_STOP_RECORD = 113; //Not really a sound
	const SOUND_FLOP = 114;
	...
	const SOUND_IMITATE_ENDERMITE = 151;
	...
	const SOUND_ITEM_TRIDENT_HIT = 178;
	const SOUND_ITEM_TRIDENT_RETURN = 179;
	const SOUND_ITEM_TRIDENT_RIPTIDE_1 = 180;
	const SOUND_ITEM_TRIDENT_RIPTIDE_2 = 181;
	const SOUND_ITEM_TRIDENT_RIPTIDE_3 = 182;
	const SOUND_ITEM_TRIDENT_THROW = 183;
	const SOUND_ITEM_TRIDENT_THUNDER = 184;
	const SOUND_ITEM_TRIDENT_HIT_GROUND = 185;

	const SOUND_ELEMCONSTRUCT_OPEN = 188;
	const SOUND_ICEBOMB_HIT = 189;
	const SOUND_BALLOONPOP = 190;
	const SOUND_LT_REACTION_ICEBOMB = 191;
	const SOUND_LT_REACTION_BLEACH = 192;
	const SOUND_LT_REACTION_EPASTE = 193;
	const SOUND_LT_REACTION_EPASTE2 = 194;
	const SOUND_LT_REACTION_GLOWSTICK = 195;
	const SOUND_LT_REACTION_GLOWSTICK2 = 196;
	const SOUND_LT_REACTION_LUMINOL = 197;
	const SOUND_LT_REACTION_SALT = 198;
	const SOUND_LT_REACTION_FERTILIZER = 199;
	const SOUND_LT_REACTION_FIREBALL = 200;
	const SOUND_LT_REACTION_MGSALT = 201;
	const SOUND_LT_REACTION_MISCFIRE = 202;
	const SOUND_LT_REACTION_FIRE = 203;
	const SOUND_LT_REACTION_MISCEXPLOSION = 204;
	const SOUND_LT_REACTION_MISCMYSTICAL = 205;
	const SOUND_LT_REACTION_MISCMYSTICAL2 = 206;
	const SOUND_LT_REACTION_PRODUCT = 207;
	const SOUND_SPARKLER_USE = 208;
	const SOUND_GLOWSTICK_USE = 209;
	const SOUND_SPARKLER_ACTIVE = 210;
	const SOUND_CONVERT_TO_DROWNED = 211;
	const SOUND_BUCKET_FILL_FISH = 212;
	const SOUND_BUCKET_EMPTY_FISH = 213;
	const SOUND_BUBBLE_COLUMN_UPWARDS = 214;
	const SOUND_BUBBLE_COLUMN_DOWNWARDS = 215;
	const SOUND_BUBBLE_POP = 216;
	const SOUND_BUBBLE_UP_INSIDE = 217;
	const SOUND_BUBBLE_DOWN_INSIDE = 218;
	const SOUND_HURT_BABY = 219;
	const SOUND_DEATH_BABY = 220;
	const SOUND_STEP_BABY = 221;
	const SOUND_SPAWN_BABY = 222;
	const SOUND_BORN = 223;
	const SOUND_TURTLE_EGG_BREAK = 224;
	const SOUND_TURTLE_EGG_CRACK = 225;
	const SOUND_TURTLE_EGG_HATCHED = 226;
	const SOUND_LAY_EGG = 227;
	const SOUND_TURTLE_EGG_ATTACKED = 228;
	const SOUND_BEACON_ACTIVATE = 229;
	const SOUND_BEACON_AMBIENT = 230;
	const SOUND_BEACON_DEACTIVATE = 231;
	const SOUND_BEACON_POWER = 232;
	const SOUND_COUDUIT_ACTIVATE = 233;
	const SOUND_COUDUIT_AMBIENT = 234;
	const SOUND_COUDUIT_ATTACK = 235;
	const SOUND_COUDUIT_DEACTIVATE = 236;
	const SOUND_COUDUIT_SHORT = 237;
	const SOUND_DEFAULT = 238;
	const SOUND_UNDEFINED = 239;
